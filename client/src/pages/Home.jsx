...
const Home = () => {
    ...
    return (
        <div className="home-layout" style={{
            ...
            {/* Clean Top Navigation Bar — No Duplicate Buttons */}
            <nav className="home-nav" style={{
                ...
                boxShadow: '0 20px 40px -15px rgba(0, 0, 0, 0.8), 0 0 35px rgba(56, 189, 248, 0.12)'
            }}>
                <div className="home-brand" style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '1.35rem', fontWeight: 800 }}>
                    <div style={{ background: 'linear-gradient(135deg, #2563eb, #0284c7)', padding: '9px 12px', borderRadius: '14px', boxShadow: '0 0 20px rgba(37, 99, 235, 0.6)', border: '1px solid rgba(255, 255, 255, 0.25)' }}>
                        <i className="fas fa-cubes brand-logo" style={{ color: '#fff' }}></i>
                    </div>
                    <span style={{ fontWeight: 900, letterSpacing: '-0.5px', color: '#fff' }}>
                        Gatherly
                    </span>
                </div>
                ...
                <div className="home-nav-links" style={{ display: 'flex', alignItems: 'center', gap: '28px' }}>
                    ...
                    <Link to="/login" className="btn blue-glow-btn" style={{ borderRadius: '12px', padding: '10px 22px', fontSize: '0.9rem', fontWeight: 800, boxShadow: '0 0 25px rgba(37, 99, 235, 0.45)', marginLeft: '8px' }}>
            ...
            <header className="hero-section" style={{ padding: '65px 20px 40px', textAlign: 'center', zIndex: 5, position: 'relative', maxWidth: '1100px', margin: '0 auto', width: '100%' }}>
                <div style={{
                    ...
                    <span className="radar-ping" style={{ width: 9, height: 9, borderRadius: '50%', backgroundColor: '#38bdf8', display: 'inline-block' }}></span>
                    <span style={{ fontSize: '0.85rem', fontWeight: 800, color: '#7dd3fc', letterSpacing: '0.6px', textTransform: 'uppercase' }}>⚡ Next-Gen Event Intelligence & Arcade Platform</span>
                </div>
                ...
                <p style={{ fontSize: '1.18rem', color: '#94a3b8', maxWidth: '700px', margin: '0 auto 38px', lineHeight: 1.65, fontWeight: 400 }}>
                ...
                {/* Primary Action Buttons (Clean & Non-Duplicate) */}
                <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '60px' }}>
                    <Link to="/login" className="btn blue-glow-btn btn-lg" style={{ padding: '15px 36px', fontSize: '1.05rem', borderRadius: '16px', fontWeight: 800, display: 'inline-flex', alignItems: 'center', gap: '10px', boxShadow: '0 0 35px rgba(37, 99, 235, 0.55)' }}>
                        <span>Explore Dashboard</span> <i className="fas fa-arrow-right"></i>
                    </Link>
                    <button onClick={scrollToDemo} className="btn btn-secondary btn-lg" style={{ padding: '15px 28px', fontSize: '1.05rem', borderRadius: '16px', background: 'rgba(56, 189, 248, 0.1)', color: '#38bdf8', border: '1.5px solid rgba(56, 189, 248, 0.35)', display: 'inline-flex', alignItems: 'center', gap: '10px', fontWeight: 800, cursor: 'pointer', boxShadow: '0 0 25px rgba(56, 189, 248, 0.15)' }}>
                        <i className="fas fa-play-circle" style={{ color: '#38bdf8', fontSize: '1.25rem' }}></i> Watch Video Tour
                    </button>
                </div>
            </header>
            ...
            <section id="features" style={{ zIndex: 5, maxWidth: '1140px', margin: '0 auto 60px', width: '100%', padding: '0 24px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '24px' }}>
                    ...
                    <div className="card-cyber-glow" style={{
                        ...
                        flexDirection: 'column',
                        gap: '16px',
                        boxShadow: '0 20px 45px -15px rgba(0, 0, 0, 0.7), inset 0 1px 0 rgba(255, 255, 255, 0.1)'
                    }}>
                        <div style={{ width: '54px', height: '54px', borderRadius: '16px', background: 'rgba(37, 99, 235, 0.2)', border: '1px solid rgba(56, 189, 248, 0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#38bdf8', fontSize: '1.5rem', boxShadow: '0 0 25px rgba(56, 189, 248, 0.3)' }}>
                    ...
                    <div className="card-cyber-glow" style={{
                        ...
                        <div style={{ width: '54px', height: '54px', borderRadius: '16px', background: 'rgba(52, 211, 153, 0.2)', border: '1px solid rgba(52, 211, 153, 0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#34d399', fontSize: '1.5rem', boxShadow: '0 0 25px rgba(52, 211, 153, 0.3)' }}>
                    ...
                    <div className="card-cyber-glow" style={{
                        ...
                        <div style={{ width: '54px', height: '54px', borderRadius: '16px', background: 'rgba(192, 132, 252, 0.2)', border: '1px solid rgba(192, 132, 252, 0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#c084fc', fontSize: '1.5rem', boxShadow: '0 0 25px rgba(192, 132, 252, 0.3)' }}>
            ...
            <section id="explore-arcade-section" style={{ zIndex: 5, maxWidth: '1140px', margin: '0 auto 70px', width: '100%', padding: '0 24px' }}>
                <div style={{
                    ...
                    borderRadius: '26px',
                    padding: '36px',
                    boxShadow: '0 25px 60px rgba(0,0,0,0.8), 0 0 45px rgba(251, 191, 36, 0.2)',
                    display: 'flex',
                    justifyContent: 'space-between',
                    alignItems: 'center',
                    flexWrap: 'wrap',
